...
sub(model,'metadata',{'name':'Title'}).text='Pegboard anchor — two print orientations'
sub(model,'metadata',{'name':'Description'}).text='Geometry only. Flat anchor or upright anchor with four cut-away webs. Select your printer and filament before slicing. No machine-specific settings or G-code.'
resources=sub(model,'resources');build=sub(model,'build')
for oid,name,path,shift in [(1,'FLAT_support_free',root/'cad/anchor_default_3p94mm.stl',(15,15,0)),(2,'UPRIGHT_cut_four_webs',root/'cad/anchor_upright_supported.stl',(65,15,0))]:
...
out=root/'Pegboard_Print_Options.3mf'
