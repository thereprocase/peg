# MS01 v2 — lettered magnetic shaft sampler

Open `part-ms01-shaft-fit-sampler-20x10x3__v2__P1S-04-PLA__PRINT-ME.gcode.3mf` in OrcaSlicer. Print plate 1 (sixteen plugs) FIRST, then either
or both strips on plates 2 and 3. `part-ms01-shaft-fit-sampler-20x10x3__v2__P1S-04-PLA__EDIT-ME.3mf` is the editable project; changes
...
|---|---|---|---|
| 1 | 16 plugs FIRST | 7.73 g | 28m 14s |
...
plug below the rim. The nominal plug top is 1.0 mm below the completed surface.
...
Pocket cross section: 10.4 x 3.4 mm. Plug: 10 x 2.95 x 14.0 mm, printed broad-face
down. In print coordinates the magnet occupies Z=3..23, plug Z=23..37.0, and cap
