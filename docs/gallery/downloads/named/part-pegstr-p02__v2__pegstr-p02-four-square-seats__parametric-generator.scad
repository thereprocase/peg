...
union() {
  import("part-pegstr-p02__v2__pegstr-p02-four-square-seats__receiver-host.stl");
  for(x=[-12.7, 12.7]) translate([x,0,0]) our_peg();
  multmatrix([[0,-1,0,0],[-1,0,0,1.75],[0,0,-1,-1.983499889],[0,0,0,1]])
    intersection() {
      import("part-pegstr-p02__v2__pegstr-p02-four-square-seats__reference-original.stl");
