...
union() {
  import("part-pegstr-p06__v2__pegstr-p06-100x60-bin__receiver-host.stl");
  for(x=[-38.1, 38.1]) translate([x,0,0]) our_peg();
  multmatrix([[0,-1,0,0],[-1,0,0,1.75],[0,0,-1,-1.983499889],[0,0,0,1]])
    intersection() {
      import("part-pegstr-p06__v2__pegstr-p06-100x60-bin__reference-original.stl");
