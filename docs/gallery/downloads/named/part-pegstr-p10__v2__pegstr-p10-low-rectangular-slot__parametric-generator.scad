...
union() {
  import("part-pegstr-p10__v2__pegstr-p10-low-rectangular-slot__receiver-host.stl");
  for(x=[-12.7, 12.7]) translate([x,0,0]) our_peg();
  multmatrix([[0,-1,0,0],[-1,0,0,1.75],[0,0,-1,-1.983499889],[0,0,0,1]])
    intersection() {
      import("part-pegstr-p10__v2__pegstr-p10-low-rectangular-slot__reference-original.stl");
