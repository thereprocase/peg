...
union() {
  import("part-pegstr-p04__v2__pegstr-p04-windscreen-tool-cradle__receiver-host.stl");
  for(x=[-12.7, 12.7]) translate([x,0,0]) our_peg();
  multmatrix([[0,-1,0,0],[-1,0,0,1.75],[0,0,-1,-1.983499889],[0,0,0,1]])
    intersection() {
      import("part-pegstr-p04__v2__pegstr-p04-windscreen-tool-cradle__reference-original.stl");
