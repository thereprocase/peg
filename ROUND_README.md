# Previous round release guide

This page preserves the guide for the **previous 5.6 mm round-peg release**. Its CAD, supported 3MF, slicing results, dimensions and visuals belong to that geometry. The current 120-degree bore-matching design is documented in [README.md](README.md) and [CONFORMAL_STUDY.md](CONFORMAL_STUDY.md). The supports on this page are not supports for the current conformal anchor.

The historical guide follows; references to "current" below mean the round release at that checkpoint.
